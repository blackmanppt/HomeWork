...
namespace HomeWork.Controllers
{
    public class 客戶資料Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,客戶名稱,統一編號,電話,傳真,地址,Email,密碼")] 客戶資料 客戶資料)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,客戶名稱,統一編號,電話,傳真,地址,Email,密碼")] 客戶資料 客戶資料)
        {
            if (ModelState.IsValid)
            {
